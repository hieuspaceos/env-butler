// Settings section: Supabase connection config (URL + service role key).
...
export default function SettingsSupabaseForm({ initialUrl, initialKey, setError, setSaved }: SettingsSupabaseFormProps) {
